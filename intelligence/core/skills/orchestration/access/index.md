...
> **Purpose:** Synthesize permission and access audits to ensure vault integrity.
> **Role:** Access Auditor
> **Field Partner:** Changelog Auditor

---

## Overview

The Access Auditor ensures that agents are operating within their defined roles and following the **Artifact-First Workflow**. It uses Changelog Auditor's technical scans as "field data" and synthesizes them into actionable reports.
...
- [ ] Automation of credential scanning (Changelog Auditor Check 9.2).
- [ ] Direct integration with Intelligence (Synthesize) for creed-access matching.
