...
SCRIPTS_DIR = os.path.join(REPO_ROOT, "orchestration/pipelines/product/projects/pipeline")
DATA_FILE = os.path.join(REPO_ROOT, "orchestration/pipelines/product/projects/inputs/status-reports/processed/asana_active.json")
JIRA_FILE = os.path.join(REPO_ROOT, "orchestration/pipelines/product/projects/inputs/status-reports/processed/jira_issues.json")
JIRA_RAW_DIR = os.path.join(REPO_ROOT, "orchestration/pipelines/product/projects/inputs/status-reports/raw/jira")
