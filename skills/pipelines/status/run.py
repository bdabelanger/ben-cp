...
DETAILED_REPORT_DIR = os.path.join(REPO_ROOT, "reports", "projects")
DETAILED_REPORT_URL = "reports/projects/report.md"
...
try:
    ...
    try:
        from scripts.07_build_report import PlatformStatusReport
        _LEGACY_AVAILABLE = True
    except:
