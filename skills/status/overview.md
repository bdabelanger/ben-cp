...
> **Cowork plugin:** This skill is mirrored in the Cowork runtime plugin (`task-capture/SKILL.md`). Update this repo version first; keep the plugin in sync manually until auto-sync is in place. The repo version is the canonical reference and edit target.
