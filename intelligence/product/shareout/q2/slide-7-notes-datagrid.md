...
## Key Benefits
- **GA Target:** Shifting to **April 23 (4-2 release)** to ensure performance stability (addressing lagging experience for large page sizes).
- **Audit Ready:** Locked notes are excluded from search/grid for users without permissions.
