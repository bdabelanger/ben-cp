...
1. **Syntax Validation:**
   - Scan recent `outputs/` for non-standard emoji usage (e.g., using 🔴 instead of 🛑 or ❌).
   - Verify that all `SKILL.md` files contain the required frontmatter and strategic headings.
2. **Aesthetic Audit:**
