...
> Detail log for `intelligence/core/skills/orchestration/`. See root `changelog.md` for version history.
...
- `/Users/benbelanger/My Drive (ben.belanger@casebook.net)/ben-cp/intelligence/core/skills/orchestration/notes/SKILL.md` — Rewrote to document new tools with copy-paste examples, removed all shell_exec patterns ✅ Complete
...
**Files changed:**
- `/Users/benbelanger/My Drive (ben.belanger@casebook.net)/ben-cp/intelligence/core/skills/orchestration/notes/SKILL.md` — Rewrote as Notes & Context skill with explicit CRU tool patterns, Notes Map table, and ownership rule ✅ Complete

**Handoff:** `handoff/complete/2026-04-12-p2-refactor-communication-to-notes-skill-COMPLETE.md`

**Next:** Update the 3 hardcoded intelligence/core/skills/orchestration/notes/ path references in predict/SKILL.md, synthesize/audit.md, and shared/separation-policy.md if naming ever changes
