...
DATA_FILE = os.path.join(REPO_ROOT, "orchestration", "pipelines", "inputs", "status-reports", "processed", "asana_active.json")
JIRA_FILE = os.path.join(REPO_ROOT, "orchestration", "pipelines", "inputs", "status-reports", "raw", "jira_issues.json")
JIRA_RAW_DIR = os.path.join(REPO_ROOT, "orchestration", "pipelines", "inputs", "status-reports", "raw", "jira")
