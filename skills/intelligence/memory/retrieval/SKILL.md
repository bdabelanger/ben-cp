...
## Connections
- **Input:** Current task summary, keywords, and domain paths.
...
2. **Retrieval:** Querying the Memory Store for structural and narrative context.
3. **Injection:** Producing and writing a brief "Context Brief" for the active agent.

## Constraints
- Focused on "Standardized Retrieval": Must use established memory protocols.
- Prioritizes accuracy over volume; brief, high-impact context only.
