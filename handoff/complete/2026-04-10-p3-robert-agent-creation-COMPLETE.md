...
Robert is named after Ben's uncle, and carries the spirits of **Robert Frost** and **Robert Burns** — poets who believed that form should serve truth, that plain language could carry deep meaning, and that the ground beneath your feet matters.
...
Robert is the safeguard. He runs a diff against recent Git history, reads the Creed, and flags anything that looks like drift — for Ben to review, not for Robert to resolve.
...
- How to invoke him: manually by Ben or any agent who suspects drift

### 2. `skills/robert/` — Skill directory
Create the following files:

**`skills/robert/index.md`** — brief overview + links to procedure files

**`skills/robert/diff_checker.md`** — procedure:
...
5. Produce a plain-language report: what changed, whether it looks like drift, confidence level (high/medium/low), and recommended action (none / flag for Ben / escalate)
6. Do not write to any file — report only

**`skills/robert/art.md`** — Robert's poem collection. Seed it with the Creed poem Gemma wrote, attributed to her. This file follows the same discipline as `changelog.md` and `index.md` — it lives in every directory Robert touches and accumulates over time. Format:
...
**`skills/robert/changelog.md`** — Robert's skill changelog, same format as other skill changelogs.
...
- Add `skills/robert/` to the vault structure tree (with `index.md`, `diff_checker.md`, `art.md`, `changelog.md`)
...
- **Optional per directory** — only Robert creates them, starting with `skills/robert/art.md`
...
5. **Create** `skills/robert/index.md` — brief overview + links
6. **Create** `skills/robert/diff_checker.md` — full procedure per architecture above
7. **Create** `skills/robert/art.md` — seed with the Creed poem, attributed to Gemma, dated 2026-04-10
8. **Create** `skills/robert/changelog.md` — initial entry for Robert's creation
...
11. **Changelog** — write subdirectory entry (`skills/robert/`), then root
