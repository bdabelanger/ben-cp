...
> **Target Domain:** `intelligence/` (primarily `intelligence/product/`)
> **Priority:** P1
...
3. **Cross-Domain Audit**: Check `intelligence/mapping` and other folders for links that might be breaking due to the `product` move.
4. **No New Source Data**: If you find files that seem mislocated, DO NOT move them yourself—simply update the indices to point to their current location or flag them in your session notes.
