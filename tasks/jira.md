...
- [IDEA-17 — Duplicate identification/prevention for People](https://casecommons.atlassian.net/browse/IDEA-17) _(P2 · In Development)_

## Platform
- [CBP-2265 — Communications - Client name not populating in Text Messages (onehh)](https://casecommons.atlassian.net/browse/CBP-2265) _(P4 · To do)_
- [CBP-2728 — Intake Creation Fails with Buffering Issue](https://casecommons.atlassian.net/browse/CBP-2728) _(P4 · To do)_
- [CBP-2448 — Dates were imported using IST time zone, should be updated to EST (newleashonlife)](https://casecommons.atlassian.net/browse/CBP-2448) _(P4 · To do)_
- [CBP-3026 — FE - In Service Enrollment, the Service list on the data grid cannot be hidden](https://casecommons.atlassian.net/browse/CBP-3026) _(P3 · To do)_
...
- [CBP-3138 — Text Message Syncing - Delete individual text messages and entire threads](https://casecommons.atlassian.net/browse/CBP-3138) _(P2 · QA revise)_
...
- [CBP-3077 — Communications - Calendar/email syncing bugs](https://casecommons.atlassian.net/browse/CBP-3077) _(P2 · To do)_
...
- [CBP-3184 — Dynamic Pages - custom_schema Bug Research & Stability Work Plan](https://casecommons.atlassian.net/browse/CBP-3184) _(P2 · To do)_
- [CBP-498 — Data import - Q4 2025](https://casecommons.atlassian.net/browse/CBP-498) _(P2 · To do)_
- [CBP-1632 — Dynamic Pages - Dynamic Pages for Attachments](https://casecommons.atlassian.net/browse/CBP-1632) _(P2 · To do)_
- [CBP-3023 — Dynamic Pages - iforms schema migration](https://casecommons.atlassian.net/browse/CBP-3023) _(P2 · To do)_
- [CBP-2808 — FE - Archived service group is still displayed under Groups filter on Services WLV](https://casecommons.atlassian.net/browse/CBP-2808) _(P2 · Blocked - Needs Review)_
- [CBP-3045 — FE - Unable to Pin All Columns to Left or Right in Add Service Enrollment Grid. Only Few columns are able to Pin](https://casecommons.atlassian.net/browse/CBP-3045) _(P2 · To do)_
- [CBP-2398 — Integrations - Expand Zapier coverage](https://casecommons.atlassian.net/browse/CBP-2398) _(P2 · To do)_
...
- [CBP-1120 — ----------------- BELOW IS NOT PRIORITIZED -----------------](https://casecommons.atlassian.net/browse/CBP-1120) _(P2 · To do)_
- [CBP-2636 — 2025 OKRs](https://casecommons.atlassian.net/browse/CBP-2636) _(P2 · To do)_
- [CBP-1826 — Alleged Perpetrator and Alleged Victim field names are not retrieved fully on re add deleted field dialog](https://casecommons.atlassian.net/browse/CBP-1826) _(P2 · To do)_
- [CBP-391 — BE Paginate API calls to assignments](https://casecommons.atlassian.net/browse/CBP-391) _(P2 · Released)_
- [CBP-1097 — uat](https://casecommons.atlassian.net/browse/CBP-1097) _(P2 · Released)_
- [CBP-450 — Form.io PDF server upgrade](https://casecommons.atlassian.net/browse/CBP-450) _(P2 · Released)_
- [CBP-344 — [PROD] Migration](https://casecommons.atlassian.net/browse/CBP-344) _(P2 · Released)_
- [CBP-191 — Provider / agency](https://casecommons.atlassian.net/browse/CBP-191) _(P2 · Released)_
- [CBP-688 — FE - Display Actual End Date and Reason for Ending Service in edit service enrollment dialog](https://casecommons.atlassian.net/browse/CBP-688) _(P1 · Released)_
- [CBP-687 — BE - Incorrect Chargebee subscription max users displayed in Tenant metrics table](https://casecommons.atlassian.net/browse/CBP-687) _(P0 · Released)_
