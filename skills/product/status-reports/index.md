...
```
inputs/status-reports/raw/jira/{KEY}.json        e.g.  inputs/status-reports/raw/jira/CBP-2736.json
inputs/status-reports/raw/jira/{KEY}_epic.json   e.g.  inputs/status-reports/raw/jira/CBP-2736_epic.json
```
...
### 1. Mode Detection
- **Single-project mode**: human user shares an Asana project URL. Pass it as an argument: `python3 full_run.py https://app.asana.com/0/...`
...
```
python3 tools/status-reports/scripts/full_run.py --force --team reporting
```
