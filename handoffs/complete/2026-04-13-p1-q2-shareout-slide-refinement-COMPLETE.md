...
| File | Path |
|------|------|
| **PPTX (edit this)** | `reports/dream/Q2 2026 Product Shareout.pptx` |
| **PDF (reference)** | `reports/dream/Q2 2026 Product Shareout.pdf` |
| **TXT extract** | `reports/dream/Q2 2026 Product Shareout.txt` — full slide text already extracted, read this first |
| **Live project status** | `reports/dream/reports/product-projects.md` |
...
### PPTX Skill
- Extract text: `python -m markitdown "reports/dream/Q2 2026 Product Shareout.pptx"`
...
1. **Read the TXT** — `reports/dream/Q2 2026 Product Shareout.txt` — use this as your slide reference
