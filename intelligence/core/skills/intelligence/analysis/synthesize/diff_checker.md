...
3. **Read Current State:**
   ...
   Then read `intelligence/core/skills/shared/separation-policy.md` § The Four Layers.
...
4. **Compare and Formulate Report:**
   ...
   - **Directory Boundaries drift:** The four-layer table in `AGENTS.md § Directory Boundaries` must match the table in `intelligence/core/skills/shared/separation-policy.md § The Four Layers`. If one has been updated but the other hasn't, flag as drift. Specifically watch for:
