...
def _load_dotenv():
    """Load .env from the git repo root (two levels above skills/project-status-reports/)."""
    # REPO_ROOT = ben-cp/skills/project-status-reports/  →  parent = ben-cp/skills/  →  grandparent = ben-cp/
    env_path = os.path.join(os.path.dirname(os.path.dirname(REPO_ROOT)), ".env")
