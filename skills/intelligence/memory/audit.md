---
title: Audit Procedure Memory Store
type: intelligence
domain: skills/intelligence/memory
---

# Audit Procedure: Memory Store

> **Owner:** Vault Auditor (Senior Archivist)

## Requirements
- [ ] Structural Hygiene: No orphaned files, misplaced data, or duplicate entries.
- [ ] Memory Integrity: No significant intelligence lost to noise.
- [ ] Ledger Accuracy: Every modification to the store must be recorded in the changelog.
...
1. **Global Scan:** Review the `vault/root` against `mapping/` standards.
2. **Compliance Check:** Verify all subdirectories have an `index.md`.
3. **Flagging:** Report violations to the central `outputs/` tree.
