...
def print_status():
    ...
    print("  → Script: python3 scripts/01_harvest.py")
    print()
    print("Stage 02: parse       [AGENT-ASSISTED]")
    print("  → Apply LLM synthesis to extract structured vault intelligence records")
    print("  → Script: python3 scripts/02_parse.py <file_path>")
    print()
    print("Stage 03: scan_orphans [AUTOMATED]")
    print("  → Verify all source files have matching .md records; list any gaps")
    print("  → Script: python3 scripts/03_scan_orphans.py")
    print("         or: python3 run.py --scan")
    print()
    print("Schema: skills/pipelines/intelligence/schemas/source-to-intelligence-prompt.md")
