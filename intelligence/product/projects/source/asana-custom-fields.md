...
Text field. Store full URL: `https://casecommons.atlassian.net/browse/CBP-XXXX`
...
**Note:** Do not set Release Date(s) — it is a sprint-cycle enum that updates with each release and will go stale.
