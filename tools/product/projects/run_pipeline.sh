...
VAULT_ROOT="$(cd "$SCRIPT_DIR/../.." && pwd)"   # tools/status-reports/ → vault root
ENV_FILE="$VAULT_ROOT/.env"
LOG_FILE="$VAULT_ROOT/outputs/status-reports/logs/run.log"

mkdir -p "$VAULT_ROOT/outputs/status-reports/logs"
