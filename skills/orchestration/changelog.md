...
- `/Users/benbelanger/My Drive (ben.belanger@casebook.net)/ben-cp/skills/orchestration/communication/SKILL.md` — Rewrote to document new tools with copy-paste examples, removed all shell_exec patterns ✅ Complete
...
**Files changed:**
- `/Users/benbelanger/My Drive (ben.belanger@casebook.net)/ben-cp/skills/orchestration/communication/SKILL.md` — Rewrote as Notes & Context skill with explicit CRU tool patterns, Notes Map table, and ownership rule ✅ Complete
