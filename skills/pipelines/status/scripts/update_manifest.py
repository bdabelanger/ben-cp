...
def reset_manifest():
    ...
    for step in data['steps']:
        ...
        if step['id'] == "1_asana_ingest":
            step['file'] = "reports/projects/data/processed/asana_active.json"
        elif step['id'] == "2_atlassian_fetch":
            step['file'] = "reports/projects/data/raw/jira"
        elif step['id'] == "3_rovo_context":
            step['file'] = "reports/projects/data/processed/rovo_insights.json"
        elif step['id'] == "4_jira_harvest":
            step['file'] = "reports/projects/data/processed/jira_issues.json"
        elif step['id'] == "5_report_generation":
            step['file'] = "reports/projects/report.md"
