...
PROJECTS_PIPELINE_JSON = os.path.join(REPO_ROOT, "reports/status/data/processed/asana_active.json")
FETCH_SCRIPT = os.path.join(os.path.dirname(__file__), "confluence_v2.py")
