...
> **Source Domain:** `tasks/q2-shareout/`
> **Target Strategic Domain:** `intelligence/product/roadmap/shareout/q2/`
> **Target Tactical Domain:** `intelligence/product/roadmap/projects/q2/`
> **Priority:** P2
...
2. **Tactical Alignment**: If the task files contain technical details or GIDs not already present in the project files, ensure they are merged into the correct records in `intelligence/product/roadmap/projects/q2/`.
...
4. **Task Finalization**: Once the data is successfully migrated and the indices are updated, the `tasks/q2-shareout/` directory can be archived, and THIS handoff marked as complete.
