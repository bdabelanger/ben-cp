...
## Connections
- **Input:** `intelligence/core/skills/orchestration/notes/` (human user notes), latest Dream Cycle digests, and all vault manifests.
- **Output:** `intelligence/core/skills/intelligence/analysis/predict/outputs/reports/`, feeds into Dream Cycle (Strategic Outlook).
